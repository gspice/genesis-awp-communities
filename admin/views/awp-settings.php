...
<div class="wrap">
	<h2>Genesis AWP Community Settings</h2>
        ...
        <div id="post-body">
            <div id="post-body-content" class="has-sidebar-content">
				...
				<form action="options.php" method="post" id="awp-stylesheet-options-form">
					...
					<?php echo '<h4><input name="plugin_awp_community_settings[stylesheet_load]" type="checkbox" value="1" class="code" ' . checked(1, $awp_options['stylesheet_load'], false ) . ' /> Deregister Genesis AWP Community CSS?</h4>'; ?>
